  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-lift': '0 20px 40px rgba(0,0,0,0.12), 0 8px 16px rgba(0,0,0,0.08)',
        'navbar': '0 1px 3px rgba(0,0,0,0.05)',
        'glow-primary': '0 4px 20px rgba(14, 165, 233, 0.4)',
        'glow-secondary': '0 4px 20px rgba(168, 85, 247, 0.4)',
        'glow-accent': '0 4px 20px rgba(249, 115, 22, 0.4)',
